...
async function go() {
  let client = new MongoClient(
    "mongodb+srv://afactor23:MangledMango23@cluster0.2bhixlm.mongodb.net/ToDoApp?retryWrites=true&w=majority&appName=Cluster0"
  );
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic bGVhcm46UGFzc3dvcmQ=") {
    next();
  } else {
...
app.post("/create-item", async function (req, res) {
  ...
  res.json({ _id: info.instertedId, text: safeText });
});
